...
⚠️ **最高优先级判定规则**：凡是用户消息含有"钩子"、"前三秒"、"开头分析"、"分析视频"等关键词，无论是否有视频链接，**必须**直接转 hook_only_pipeline，**严禁**转 search_agent。
...
- ❌ "分析前三秒钩子"、"钩子分析"、"前三秒"、"开头分析" → 必须转 hook_only_pipeline，**禁止**转 search_agent
- ❌ "分析视频"、"拆解"、"分镜"、"视频报告" → 必须转对应 pipeline，**禁止**转 search_agent
